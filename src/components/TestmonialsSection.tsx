...
const TestimonialsSection = () => (
  <section className="tw-relative tw-py-12 tw-bg-gray-100 tw-overflow-hidden">
    ...
    <div className="tw-relative lg:tw-h-[250px]">
      <div className="tw-hidden lg:tw-block tw-absolute tw-inset-0 tw-z-10">
      ...
      <div
        className="tw-hidden lg:tw-block tw-absolute tw-inset-0 tw-z-20 pointer-events-none"
        style={{
          background:
            'linear-gradient(to right, rgb(243 244 246) 30%, rgba(255,255,255,0) 100%)',
        }}
      />
            ...
            <div className="tw-flex tw-items-end tw-space-x-4 tw-mb-6">
              ...
              <div className="tw-flex tw-items-center tw-space-x-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="tw-w-6 tw-h-6 tw-fill-yellow-400 tw-text-yellow-400"
                  />
                ))}
              </div>
            </div>
      ...
      <div className="tw-block lg:tw-hidden tw-relative tw-z-10 ">
        <Marquee speed={30} gradient={false} className="tw-flex tw-items-center tw-h-full tw-py-6">
          {testimonials.map((t, i) => (
            <TestimonialCard key={i} testimonial={t} />
          ))}
        </Marquee>
